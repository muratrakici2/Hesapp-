...
export default function AltıKişi() {
  ...
  const Hesapp = () => {
    setms1((Number(m1) - Number(m2)) / 6)
    setms2((Number(m1) - Number(m3)) / 6)
    setms3((Number(m1) - Number(m4)) / 6)
    setms4((Number(m1) - Number(m5)) / 6)
    setms5((Number(m1) - Number(m6)) / 6)
    setms6((Number(m2) - Number(m3)) / 6)
    setms7((Number(m2) - Number(m4)) / 6)
    setms8((Number(m2) - Number(m5)) / 6)
    setms9((Number(m2) - Number(m6)) / 6)
    setms10((Number(m3) - Number(m4)) / 6)
    setms11((Number(m3) - Number(m5)) / 6)
    setms12((Number(m3) - Number(m6)) / 6)
    setms13((Number(m4) - Number(m5)) / 6)
    setms14((Number(m4) - Number(m6)) / 6)
    setms15((Number(m5) - Number(m6)) / 6)
      ...
      <View style={{ marginTop: 10 }}></View>
        ...
        {ms1 === 0 ? null:
          ...
          <View style={styles.hesapkısmı}>
            ...
            <Text style={styles.yazılar}>{k3}</Text>
            <View style={{ justifyContent: "center", alignItems: "center", flex: 1 }}>
              <AntDesign size={22} name={ms11 > 0 ? "arrowleft" : "arrowright"}></AntDesign>
