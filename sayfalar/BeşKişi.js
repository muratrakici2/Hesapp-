...
export default function BeşKişi() {
  ...
  const Hesapp = () => {
    setms1((Number(m1) - Number(m2)) / 5)
    setms2((Number(m1) - Number(m3)) / 5)
    setms3((Number(m1) - Number(m4)) / 5)
    setms4((Number(m1) - Number(m5)) / 5)
    setms5((Number(m2) - Number(m3)) / 5)
    setms6((Number(m2) - Number(m4)) / 5)
    setms7((Number(m2) - Number(m5)) / 5)
    setms8((Number(m3) - Number(m4)) / 5)
    setms9((Number(m3) - Number(m5)) / 5)
    setms10((Number(m4) - Number(m5)) / 5)
